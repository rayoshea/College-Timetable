...
namespace TallaghtTimetable.Controllers
{
    public class LecturersController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ID,IconsID,StudysID,Name,Modules")] Lecturer lecturer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ID,IconsID,StudysID,Name,Modules")] Lecturer lecturer)
        {
            if (ModelState.IsValid)
            {
